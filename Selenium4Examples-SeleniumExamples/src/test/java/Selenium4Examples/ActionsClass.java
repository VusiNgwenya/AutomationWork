...
public class ActionsClass {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		a.moveToElement(driver.findElement(By.xpath("//a[@class='a-level-1'][contains(texy(),'Clothing & Shows']"))).build().perform();
		...
		driver.findElement(By.xpath("//div[@id='CLUBS_1']//span[@class='name'][contains(text(),'Driver']")).click();
