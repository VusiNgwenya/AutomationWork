...
public class HandlingSVGGraph {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"root\"]/div/div[2]/div[1]/div[4]")));
				
				//elementTobeClickable(By.xpath("//*[@id=\"root\"]/div/div[2]/div[1]/div[4]")));
		
		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[2]/div[1]/div[4]/div[2]/div/div[9]/div[1]")).click();
		
		List<WebElement> graphPoints = driver.findElements(By.xpath("//*[name()='svg' and @preserveApectRatio='xMidMid meet'])[6]//*[local-name()='circle']"));
